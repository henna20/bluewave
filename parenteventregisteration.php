     ...
     <div id="content">
        ...
        if(isset($_POST["register"])) {
            ...
            if($db->query($w)){
               ...
               echo "<script>window.open('parentevent.php?mess=Registeration Sucsessfull.', '_self')</script>";
        ...
        <label>Select the Name of Event</label><br>
            ...
            ?>" required class="input"><br>
             <label>Participant First Name</label><br>
            <input type="text" name="rgfirstname" required class="input"><br>
            <label>Participant Last Name</label><br>
